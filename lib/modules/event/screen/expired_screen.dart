...
class ExpiredArgument {
  final String? title;
  final String orderId;

  ExpiredArgument({this.title, required this.orderId});
}

class ExpiredScreen extends StatefulWidget {
  final ExpiredArgument? argument;

  const ExpiredScreen({Key? key, this.argument}) : super(key: key);

  static const String path = '/Expired';
  static const String title = 'Kadaluarsa';
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      divide10,
                      TextWidget(
                        'Pembayaran untuk pembelian ${data.order!.event!.title} Telah kadaluarsa!',
